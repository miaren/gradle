...
public class ArchivePublishArtifact extends AbstractPublishArtifact implements ConfigurablePublishArtifact {
    ...
    public boolean shouldBePublished() {
        /*
         * MIAREN: If the file exists, it was generated before.
         *
         * This is necessary in order to avoid "Artifact xxx wasn't produced by this build."
         *  for files that have been generated by a previous build.
         *
         * @sideeffect: Computes the archive file.
         */
        if (getFile().exists())
            return true;

        /* MIAREN: If it's not enabled, it won't be generated. */
        if (!archiveTask.isEnabled())
            return false;

        /* MIAREN: If it worked, the file has definitely been generated. */
        if (archiveTask.getDidWork())
            return true;
