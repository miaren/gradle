...
public class JavaExecHandleBuilder implements BaseExecHandleBuilder, ProcessArgumentsSpec.HasExecutable {
    ...
    public JavaExecHandleBuilder setDefaultTerminationMode(TerminationMode terminationMode) {
        execHandleBuilder.setDefaultTerminationMode(terminationMode);
        return this;
    }

    public TerminationMode getDefaultTerminationMode() {
        return execHandleBuilder.getDefaultTerminationMode();
    }
